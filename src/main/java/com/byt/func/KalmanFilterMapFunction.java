 ...
 * @date: 2022/8/1 13:47
 */
public class KalmanFilterMapFunction extends RichFlatMapFunction<TagKafkaInfo, TagKafkaInfo> {
    ...
    public KalmanFilterMapFunction(double dt, double r) {
        this.dt = dt;
        this.r = r;
    }
    ...
    @Override
    public void flatMap(TagKafkaInfo value, Collector<TagKafkaInfo> out) throws Exception {
...
//            INDArray x = Nd4j.create(new double[]{value.getValue().toBigInteger().doubleValue(), 0});
