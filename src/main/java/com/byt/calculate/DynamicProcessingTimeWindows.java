 ...
 * @date: 2023/7/4 14:19
 **/
public class DynamicProcessingTimeWindows extends WindowAssigner<Object, TimeWindow> {
    private static final long serialVersionUID = 1L;
    private final long size;
    private final long offset;
    private final long slide;

    private DynamicProcessingTimeWindows(long size, long slide, long offset) {
    ...
    public Collection<TimeWindow> assignWindows(Object element, long timestamp, WindowAssignerContext context) {
        ...
        //System.out.println(realSize+"=============="+realSlide);
    ...
    public static DynamicProcessingTimeWindows of(Time size, Time slide) {
        return new DynamicProcessingTimeWindows(size.toMilliseconds(), slide.toMilliseconds(), 0L);
    }

    public static DynamicProcessingTimeWindows of(Time size, Time slide, Time offset) {
        return new DynamicProcessingTimeWindows(size.toMilliseconds(), slide.toMilliseconds(), offset.toMilliseconds());
    }
