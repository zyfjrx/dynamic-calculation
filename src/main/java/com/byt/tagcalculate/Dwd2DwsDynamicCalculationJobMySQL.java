 ...
 */
public class Dwd2DwsDynamicCalculationJobMySQL {
        ...
        secondResult
                ...
                .addSink(
                        JdbcSink.sink(
                                ...
                                "insert into " + ConfigManager.getProperty("dws.second.table") + "(byt_name, tag_topic, value, calculate_time, calculate_type,calculate_params, job_name, line_id) values(?, ?, ?, ?, ?, ?, ?, ?);",
                                new JdbcStatementBuilder<TagKafkaInfo>() {
                                    @Override
                                    public void accept(PreparedStatement ps, TagKafkaInfo tag) throws SQLException {
                                ...
                                new JdbcConnectionOptions.JdbcConnectionOptionsBuilder()
                                        .withPassword("000000")
                                        .withUsername("root")
                                        .withUrl("jdbc:mysql://" + ConfigManager.getProperty("mysql.host") + ":" + ConfigManager.getProperty("mysql.port") + "/" + ConfigManager.getProperty("mysql.database") + "?autoReconnect=true&useSSL=false&characterEncoding=utf-8&serverTimezone=Asia/Shanghai")
