 ...
 */
public class KfProcessFuncOld extends KeyedProcessFunction<String,TagKafkaInfo,TagKafkaInfo> {
    ...
    public KfProcessFuncOld(OutputTag<TagKafkaInfo> dwdOutPutTag) {
