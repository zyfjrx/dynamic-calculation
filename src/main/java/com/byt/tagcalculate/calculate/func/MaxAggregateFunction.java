 ...
 **/
public class MaxAggregateFunction implements AggregateFunction<TagKafkaInfo, Tuple2<TagKafkaInfo, BigDecimal>, TagKafkaInfo> {

    @Override
    public Tuple2<TagKafkaInfo, BigDecimal> createAccumulator() {
        return Tuple2.of(new TagKafkaInfo(),BigDecimal.valueOf(Long.MIN_VALUE));
    }
