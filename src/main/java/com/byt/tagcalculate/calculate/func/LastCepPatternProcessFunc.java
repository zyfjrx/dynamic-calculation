 ...
 **/
public class LastCepPatternProcessFunc extends PatternProcessFunction<TagKafkaInfo, TagKafkaInfo> {
    private OutputTag<TagKafkaInfo> dwdOutPutTag;

    public LastCepPatternProcessFunc(OutputTag<TagKafkaInfo> dwdOutPutTag) {
