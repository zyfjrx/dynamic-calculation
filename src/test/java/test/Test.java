...
public class Test {
    public static void main(String[] args) throws Exception {
        ...
        Pattern<Tuple3<String, Long, String>, Tuple3<String, Long, String>> initPattern = Pattern
                .<Tuple3<String, Long, String>>begin("start").where(new RichIterativeCondition<Tuple3<String, Long, String>>() {
                    @Override
                    public boolean filter(Tuple3<String, Long, String> value, IterativeCondition.Context<Tuple3<String, Long, String>> ctx) throws Exception {
